...
interface VMSubdomainAssetTableProps {
  data: PaginatedResponse;
  onPageChange: (page: number) => void;
  isLoading?: boolean;
}

export function VMSubdomainAssetTable({
  data,
  onPageChange,
  isLoading = false,
}: VMSubdomainAssetTableProps) {
              ...
              <TableRow key={asset.uuid} className="group hover:bg-muted/50 transition-colors">
                ...
                <TableCell>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="truncate max-w-[200px]" title={asset.domainAsset.url}>
