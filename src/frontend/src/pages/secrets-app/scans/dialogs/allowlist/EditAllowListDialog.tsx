...
const EditAllowListDialog: React.FC<EditAllowListDialogProps> = ({
  open,
  onOpenChange,
  allowList,
  commonAPIRequest,
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      ...
      try {
        ...
        toast.success('Allow list updated successfully');
        onOpenChange(false);
        onSuccess();
      } catch (error) {
        toast.error('Failed to update allow list');
      } finally {
        setSubmitting(false);
      }
    },
      ...
      <DialogContent className="sm:max-w-[600px] p-0 gap-0">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <DialogTitle>Edit Allow List</DialogTitle>
              <DialogDescription>
                Update your allow list settings and configurations.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
...
export default withAPIRequest(EditAllowListDialog);
