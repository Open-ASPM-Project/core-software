...
import PRScansTable from '../table/pr-scans/PRScansTable';
import { PRScansFilters } from '../components/pr-scans/PRScansFilters';
...
const PRScansTab: React.FC<PRScansTabProps> = ({ commonAPIRequest }) => {
      ...
      <Card className="w-full border-none">
        <CardContent className="p-0 border-none shadow-none">
          ...
          <div className="flex items-center justify-between gap-4 mb-6 mt-4">
            ...
            <PRScansFilters onFiltersChange={handleFiltersChange} initialFilters={activeFilters} />
          </div>
...
export default withAPIRequest(PRScansTab);
