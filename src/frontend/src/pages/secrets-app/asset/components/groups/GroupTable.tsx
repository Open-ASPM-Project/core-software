...
import DeleteGroupDialog from '../../dialogs/groups/DeleteGroupDialog';
import EditGroupDialog from '../../dialogs/groups/EditGroupDialog';
import { cn } from '@/lib/utils';
import ViewRepositoriesForGroupDialog from '../../dialogs/groups/ViewRepositoriesForGroupDialog';
interface Group {
  id: number;
  name: string;
  description: string;
      ...
      <TableCell colSpan={6} className="h-96">
        <div className="flex flex-col items-center justify-center h-full px-4">
          <div className="bg-gradient-to-r from-violet-50 to-blue-50 dark:from-violet-900/30 dark:to-blue-900/30 p-4 rounded-full mb-4">
            <FolderEdit className="w-12 h-12 text-violet-600 dark:text-violet-400" />
          </div>
          <h3 className="text-lg font-semibold mb-2 text-center">No Groups Found</h3>
          <p className="text-sm text-muted-foreground text-center max-w-sm">
            There are currently no groups available. Try adjusting your search criteria or create a
