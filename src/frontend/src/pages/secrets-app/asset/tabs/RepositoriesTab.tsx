...
const RepositoriesTab: React.FC<RepoTableProps> = ({ commonAPIRequest }) => {
  ...
  const sort_by = (searchParams.get('sort_by') as QueryParams['sort_by']) || 'secrets_count';
...
export default withAPIRequest(RepositoriesTab);
