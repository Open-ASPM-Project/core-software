...
const SecretsAppTab = ({ className }: PreviewCodeTabsProps) => {
  ...
  return (
    ...
    >
      <TabsList className="w-full justify-start rounded-xl border bg-gradient-to-r from-slate-50 to-white dark:from-slate-900/50 dark:to-slate-900 shadow-md p-6 space-x-2">
        ...
        <TabsTrigger
          value="assets"
          onClick={() => handleNavigation('secret/assets')}
          className={tabStyle}
        >
          <div
            className={cn(
        ...
        <TabsTrigger
          value="scans"
          onClick={() => handleNavigation('secret/scans')}
          className={tabStyle}
        >
          <div
            className={cn(
        ...
        <TabsTrigger
          value="incidents"
          onClick={() => handleNavigation('secret/incidents')}
          className={tabStyle}
        >
          <div
            className={cn(
