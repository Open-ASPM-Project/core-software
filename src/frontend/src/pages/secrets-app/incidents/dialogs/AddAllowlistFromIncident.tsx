...
import { Plus, Loader2, ShieldCheck, Globe, Shield } from 'lucide-react';
...
interface AddAllowlistFromIncidentProps {
  open: boolean;
...
const AddAllowlistFromIncident: React.FC<AddAllowlistFromIncidentProps> = ({
  open,
  onOpenChange,
  incidentName,
  commonAPIRequest,
  ...
  React.useEffect(() => {
    if (open) {
      formik.setFieldValue('name', incidentName);
    }
  }, [open, incidentName]);
      ...
      <DialogContent className="sm:max-w-[600px] p-0 gap-0">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <DialogTitle>Add New Allow List from Incident</DialogTitle>
              <DialogDescription>
                Create a new allow list from an incident to manage your security exceptions.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
...
export default withAPIRequest(AddAllowlistFromIncident);
