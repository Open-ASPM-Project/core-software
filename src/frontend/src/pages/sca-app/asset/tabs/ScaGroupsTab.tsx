...
import ScaGroupTable from '../components/groups/ScaGroupTable';
import AddGroupDialog from '@/pages/secrets-app/asset/dialogs/groups/AddGroupDialog';
import { ScaGroupFilters } from '../components/groups/ScaGroupFilters';
...
const ScaGroupsTab: React.FC<GroupTableProps> = ({ commonAPIRequest }) => {
  ...
  }, [page, limit, search, order_by, sort_by, fetchGroups]);
      ...
      <Card className="w-full border-none">
        <CardContent className="p-0 border-none shadow-none">
          ...
          <div className="flex items-center justify-between gap-4 mb-6 mt-4">
            ...
            <ScaGroupFilters onFiltersChange={handleFiltersChange} initialFilters={activeFilters} />
...
export default withAPIRequest(ScaGroupsTab);
