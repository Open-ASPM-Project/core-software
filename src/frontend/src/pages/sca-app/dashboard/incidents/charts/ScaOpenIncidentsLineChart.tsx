...
function IncidentLineChartComponent({ commonAPIRequest, dateRange, assets }: APIRequestProps) {
          ...
          <div className="flex items-start justify-between">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-muted-foreground max-w-[600px]">
                Monitor and analyze security incidents and affected assets across your
      ...
      <div className="flex flex-col gap-6 p-6">
        ...
        <div className="flex items-start justify-between">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-muted-foreground max-w-[600px]">
              Monitor and analyze security incidents and affected assets across your organization's
              infrastructure.
            </p>
          </div>
          <div className="flex items-center gap-2">
...
export const ScaOpenIncidentsLineChart = withAPIRequest(IncidentLineChartComponent);
