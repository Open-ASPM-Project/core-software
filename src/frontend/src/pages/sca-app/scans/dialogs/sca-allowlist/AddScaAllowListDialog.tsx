...
interface AddScaAllowListDialogProps {
  open: boolean;
...
const AddScaAllowListDialog: React.FC<AddScaAllowListDialogProps> = ({
  open,
  onOpenChange,
  commonAPIRequest,
  onSuccess,
      ...
      <DialogContent className="sm:max-w-[600px] p-0 gap-0">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <DialogTitle>Add New SCA Allow List</DialogTitle>
              <DialogDescription>
                Create a new allow list to manage your vulnerability exceptions.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
...
export default AddScaAllowListDialog;
