...
import EditScaAllowListDialog from '../../dialogs/sca-allowlist/EditScaAllowListDialog';
import AllowListCommentsDialog from '@/pages/secrets-app/scans/dialogs/allowlist/AllowListCommentsDialog';
          ...
          {isLoading ? (
            ...
            allowList?.map((item) => (
              <TableRow key={item.id}>
                {/* Name cell - same as AllowListTable */}
                <TableCell>
                  <Badge variant={item.type === 'VULNERABILITY' ? 'secondary' : 'default'}>
                    {item.name}
                  </Badge>
                </TableCell>
                <TableCell>
...
export default ScaAllowListTable;
