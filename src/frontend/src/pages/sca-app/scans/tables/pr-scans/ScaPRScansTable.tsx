...
import ViewVulnerabilitiesForPRScansDialog from '../../dialogs/sca-pr-scans/ViewVulnerabilitiesForPRScansDialog';
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span className="font-medium min-w-[20px]">{count} Vulnerabilities</span>
      </div>
...
const ScaPRScansTable = ({
  ...
  const [isVulnerabilitiesDialogOpen, setIsVulnerabilitiesDialogOpen] = React.useState(false);

  const handleViewVulnerabilities = (pr: PR) => {
    setSelectedPR(pr);
    setIsVulnerabilitiesDialogOpen(true);
  };
  ...
  return (
    <div className="space-y-4 rounded-md dark:border-gray-700">
            ...
            {isLoading ? (
              ...
              prScans?.map((scan) => (
                ...
                >
                  ...
                  <TableCell>
                    <StatusBadge status={scan.block_status} />
                  </TableCell>
                  <TableCell>
                    <div className="flex items-center gap-2">
                  ...
                  <TableCell>
                    <SecretsBadge
                      ...
                      count={scan.vulnerability_count}
                    />
                  </TableCell>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-[160px]">
                        <DropdownMenuItem
                          onClick={() => {
                            navigate(
                              `/sca/incidents?repo_ids=${scan?.repo_id}&pr_ids=${scan?.pr?.id}`
                            );
                          }}
      ...
      {selectedPR && (
        <ViewVulnerabilitiesForPRScansDialog
          isOpen={isVulnerabilitiesDialogOpen}
          onClose={() => {
            setIsVulnerabilitiesDialogOpen(false);
            setSelectedPR(null);
          }}
...
export default ScaPRScansTable;
