...
async def list_available_filters(
    ...
    # Vulnerability-VM-specific filters
    vulnerability_vm_filters = [
        {"key": "template_ids", "label": "Template IDs", "type": "multi-select", "searchable": True},
        {"key": "template_paths", "label": "Template Paths", "type": "multi-select", "searchable": True},
        {"key": "template_encoded", "label": "Template Encoded", "type": "multi-select", "searchable": True},
        {"key": "info_names", "label": "Info Names", "type": "multi-select", "searchable": True},
        {"key": "info_severities", "label": "Info Severities", "type": "multi-select", "searchable": True},
        {"key": "info_descriptions", "label": "Info Descriptions", "type": "multi-select", "searchable": True},
        {"key": "info_impacts", "label": "Info Impacts", "type": "multi-select", "searchable": True},
        {"key": "info_remediations", "label": "Info Remediations", "type": "multi-select", "searchable": True},
        {"key": "types", "label": "Types", "type": "multi-select", "searchable": True},
        {"key": "hosts", "label": "Hosts", "type": "multi-select", "searchable": True},
        {"key": "ports", "label": "Ports", "type": "multi-select", "searchable": True},
        {"key": "schemes", "label": "Schemes", "type": "multi-select", "searchable": True},
        {"key": "urls", "label": "URLs", "type": "multi-select", "searchable": True},
        {"key": "matched_ats", "label": "Matched At", "type": "multi-select", "searchable": True},
        {"key": "requests", "label": "Requests", "type": "multi-select", "searchable": True},
        {"key": "responses", "label": "Responses", "type": "multi-select", "searchable": True},
        {"key": "ips", "label": "IPs", "type": "multi-select", "searchable": True},
        {"key": "curl_commands", "label": "cURL Commands", "type": "multi-select", "searchable": True},
        {"key": "matcher_status", "label": "Matcher Status", "type": "boolean", "searchable": True},
        {"key": "profiles", "label": "Profiles", "type": "multi-select", "searchable": True},
        {"key": "asset_ids", "label": "Asset IDs", "type": "multi-select", "searchable": True},
        {"key": "asset_names", "label": "Asset Names", "type": "multi-select", "searchable": True},
        {"key": "asset_types", "label": "Asset Types", "type": "multi-select", "searchable": True},
    ]
    ...
    elif type == IncidentTypeEnum.vulnerability_vm:
        all_filters = common_filters + vulnerability_vm_filters
