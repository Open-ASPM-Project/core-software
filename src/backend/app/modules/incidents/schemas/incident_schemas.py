...
class IncidentTypeEnum(str, Enum):
    ...
    vulnerability_vm = "vulnerability_vm"
...
class IncidentFilters(BaseModel):
    ...
    template_encoded: Optional[List[str]] = None

    info_names: Optional[List[str]] = None
    info_descriptions: Optional[List[str]] = None
    info_impacts: Optional[List[str]] = None
    info_remediations: Optional[List[str]] = None
    ...
    matched_ats: Optional[List[str]] = None
    ...
    curl_commands: Optional[List[str]] = None
    matcher_status: Optional[bool] = None
